...
dag = airflow.DAG(
    'ocredit_phones_source_binlog_hi',
...
dag_monitor = airflow.DAG(
    'ocredit_phones_binlog_hi_monitor',
    schedule_interval=schedule_interval,
    default_args=args)
...
table_list = [
    ...
    ("oloan","t_app_version", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_black_user", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_card", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_collect_record", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ...
    ("oloan","t_merchant_store_audit_log", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_merchant_store_opay_info", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ...
    ("oloan","t_pay_bill", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_pay_order", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_pay_order_fail_log", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_product", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_product_brand", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_product_brand_model", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_region_code", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ...
    ("oloan","t_risk_biz_rule", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_risk_result", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_risk_result_detail", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_sms_log", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_store_info", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
    ("oloan","t_user", "ocredit_db", "base",1, "ocredit_db_binlog","false"),
...
OSS_PATH = 'oss://opay-datalake/ocredit_binlog/%s'
...
HADOOP_MERGE_COMMAND_TEMPLATE = '''
    hadoop fs -cat oss://opay-datalake/ocredit_phones_binlog/{binlog_dir}/dt={pt}/hour={hour}/* | hadoop fs -put - {merge_target_file}
'''

# merge后文件位置模版
merge_target_file_template = 'oss://opay-datalake/ocredit_phones_binlog/{table_name}/dt={pt}/hour={hour}/00000.json'
