...
table_list = [
    ...
    ("oloan","t_app_version", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_black_user", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_card", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_collect_record", "ocredit_db", "base",1, "ocredit_db","false"),
    ...
    ("oloan","t_merchant_store_audit_log", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_merchant_store_opay_info", "ocredit_db", "base",1, "ocredit_db","false"),
    ...
    ("oloan","t_pay_bill", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_pay_order", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_pay_order_fail_log", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_product", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_product_brand", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_product_brand_model", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_region_code", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_repayment_detail", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_repayment_plan", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_risk_biz_rule", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_risk_result", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_risk_result_detail", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_sms_log", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_store_info", "ocredit_db", "base",1, "ocredit_db","false"),
    ("oloan","t_user", "ocredit_db", "base",1, "ocredit_db","false"),
...
OSS_PATH = 'oss://opay-datalake/ocredit_phones_binlog/%s'
