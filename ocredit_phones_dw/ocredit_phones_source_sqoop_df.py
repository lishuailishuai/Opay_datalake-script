...
table_list = [
    ...
    ("oloan","t_app_version", "oloan", "base",1,"true"),
    ("oloan","t_black_user", "oloan", "base",1,"true"),
    ("oloan","t_card", "oloan", "base",1,"true"),
    ("oloan","t_collect_record", "oloan", "base",1,"true"),
    ("oloan","t_contract", "oloan", "base",1,"true"),
    ("oloan","t_contract_approval_log", "oloan", "base",1,"true"),
    ("oloan","t_financial_product_car", "oloan", "base",1,"true"),
    ("oloan","t_financial_product_car_history", "oloan", "base",1,"true"),
    ("oloan","t_financial_product_phone", "oloan", "base",1,"true"),
    ("oloan","t_financial_product_phone_history", "oloan", "base",1,"true"),
    ("oloan","t_merchant_info", "oloan", "base",1,"true"),
    ("oloan","t_merchant_store_audit_log", "oloan", "base",1,"true"),
    ("oloan","t_merchant_store_opay_info", "oloan", "base",1,"true"),
    ("oloan","t_order", "oloan", "base",1,"true"),
    ("oloan","t_order_audit_history", "oloan", "base",1,"true"),
    ("oloan","t_order_down_payment", "oloan", "base",1,"true"),
    ("oloan","t_order_relate_user", "oloan", "base",1,"true"),
    ("oloan","t_overdue_config", "oloan", "base",1,"true"),
    ("oloan","t_overdue_record", "oloan", "base",1,"true"),
    ("oloan","t_pay_bill", "oloan", "base",1,"true"),
    ("oloan","t_pay_order", "oloan", "base",1,"true"),
    ("oloan","t_pay_order_fail_log", "oloan", "base",1,"true"),
    ("oloan","t_product", "oloan", "base",1,"true"),
    ("oloan","t_product_brand", "oloan", "base",1,"true"),
    ("oloan","t_product_brand_model", "oloan", "base",1,"true"),
    ("oloan","t_region_code", "oloan", "base",1,"true"),
    ("oloan","t_repayment_detail", "oloan", "base",1,"true"),
    ("oloan","t_repayment_plan", "oloan", "base",1,"true"),
    ("oloan","t_risk_biz_rule", "oloan", "base",1,"true"),
    ("oloan","t_risk_result", "oloan", "base",1,"true"),
    ("oloan","t_risk_result_detail", "oloan", "base",1,"true"),
    ("oloan","t_sms_log", "oloan", "base",1,"true"),
    ("oloan","t_store_info", "oloan", "base",1,"true"),
    ("oloan","t_user", "oloan", "base",1,"true"),
