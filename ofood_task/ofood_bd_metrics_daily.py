...
insert_bd_metrics = HiveOperator(
    ...
    hql=''' 
        ...
        order_data as (
            ...
            from 
            bd_area b 
            left join ofood_dw_ods.ods_sqoop_base_jh_order_df o on o.dt = '{{ ds }}' and o.day = '{{ ds_nodash }}'
            left join ofood_dw_ods.ods_sqoop_base_jh_waimai_order_df d on d.dt = '{{ ds }}' and o.order_id = d.order_id
            where isInArea(b.points,o.o_lat,o.o_ln) = 1
