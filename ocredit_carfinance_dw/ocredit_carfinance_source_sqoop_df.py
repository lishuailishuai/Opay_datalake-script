...
dag = airflow.DAG(
    'ocredit_carfinance_source_sqoop_df',
...
dag_monitor = airflow.DAG(
    'ocredit_carfinance_source_sqoop_df_monitor',
    schedule_interval=schedule_interval,
    default_args=args)
...
UFILE_PATH = 'oss://opay-datalake/ocredit_carfinance_dw_sqoop/%s/%s'
ODS_CREATE_TABLE_SQL = '''
    ...
    -- delete ocredit_carfinance_dw table
