...
dag = airflow.DAG(
    'ocredit_carfinance_source_binlog_hi',
...
dag_monitor = airflow.DAG(
    'ocredit_carfinance_binlog_hi_monitor',
    schedule_interval=schedule_interval,
    default_args=args)
...
OSS_PATH = 'oss://opay-datalake/ocredit_carfinance_binlog/%s'
...
HADOOP_MERGE_COMMAND_TEMPLATE = '''
    hadoop fs -cat oss://opay-datalake/ocredit_carfinance_binlog/{binlog_dir}/dt={pt}/hour={hour}/* | hadoop fs -put - {merge_target_file}
'''

# merge后文件位置模版
merge_target_file_template = 'oss://opay-datalake/ocredit_carfinance_binlog/{table_name}/dt={pt}/hour={hour}/00000.json'
