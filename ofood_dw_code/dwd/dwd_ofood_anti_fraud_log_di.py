...
dwd_ofood_anti_fraud_log_di_task = HiveOperator(
...
dwd_ofood_anti_fraud_log_di_prev_day_tesk>>sleep_time>>dwd_ofood_anti_fraud_log_di_task>>touchz_data_success