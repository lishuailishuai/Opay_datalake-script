...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "otrade_dw"
table_name = "dwd_otrade_b2b_otrade_order_hi"
...
def dwd_otrade_b2b_otrade_order_hi_sql_task(ds, v_date):
    HQL = '''
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dwd_otrade_b2b_otrade_order_hi_sql_task(ds, v_date)
...
dwd_otrade_b2b_otrade_order_hi_task = PythonOperator(
