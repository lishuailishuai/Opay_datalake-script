...
dag = airflow.DAG('dwd_otrade_b2c_order_goods_collect_hi',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "otrade_dw"
table_name = "dwd_otrade_b2c_order_goods_collect_hi"
...
def dwd_otrade_b2c_order_goods_collect_hi_sql_task(ds, v_date):
    HQL = '''
...
--4.将数据关联后插入最终表中
insert overwrite table otrade_dw.dwd_otrade_b2c_order_goods_collect_hi partition(country_code,dt,hour)
select
  v1.id
  ,v1.order_id
  ,v1.goods_id
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dwd_otrade_b2c_order_goods_collect_hi_sql_task(ds, v_date)
...
dwd_otrade_b2c_order_goods_collect_hi_task = PythonOperator(
...
dwd_otrade_b2c_mall_nideshop_order_goods_hi_check_task >> dwd_otrade_b2c_order_goods_collect_hi_task
dwd_otrade_b2c_order_collect_hi_check_task >> dwd_otrade_b2c_order_goods_collect_hi_task
dim_otrade_b2c_mall_nideshop_product_hf_check_task >> dwd_otrade_b2c_order_goods_collect_hi_task
