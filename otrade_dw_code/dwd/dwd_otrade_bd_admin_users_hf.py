...
dag = airflow.DAG('dwd_otrade_bd_admin_users_hf',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "otrade_dw"
table_name = "dwd_otrade_bd_admin_users_hf"
...
##----------------------------------------- 依赖 ---------------------------------------##
### 检查最新的商户表的依赖
dwd_otrade_bd_admin_users_hf_check_pre_locale_task = OssSensor(
    task_id='dwd_otrade_bd_admin_users_hf_check_pre_locale_task',
...
def execution_data_task_id(ds, dag, **kwargs):
   ...
   # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dwd_otrade_bd_admin_users_hf_sql_task(ds, v_date)
...
dwd_otrade_bd_admin_users_hf_task = PythonOperator(
    task_id='dwd_otrade_bd_admin_users_hf_task',
...
dwd_otrade_bd_admin_users_hf_check_pre_locale_task >> dwd_otrade_bd_admin_users_hf_task
ods_binlog_base_bd_admin_users_hi_check_task >> dwd_otrade_bd_admin_users_hf_task
