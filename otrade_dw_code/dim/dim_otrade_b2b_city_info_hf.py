...
dag = airflow.DAG('dim_otrade_b2b_city_info_hf',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "otrade_dw"
table_name = "dim_otrade_b2b_city_info_hf"
...
def dim_otrade_b2b_city_info_hf_sql_task(ds, v_date):
    HQL = '''
...
insert overwrite table otrade_dw.dim_otrade_b2b_city_info_hf partition(country_code,dt,hour)
select
  v1.id as city_code
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dim_otrade_b2b_city_info_hf_sql_task(ds, v_date)
...
dim_otrade_b2b_city_info_hf_task = PythonOperator(
    task_id='dim_otrade_b2b_city_info_hf_task',
...
ods_binlog_base_otrade_city_h_his_check_task >> dim_otrade_b2b_city_info_hf_task
ods_binlog_base_otrade_country_h_his_check_task >> dim_otrade_b2b_city_info_hf_task
