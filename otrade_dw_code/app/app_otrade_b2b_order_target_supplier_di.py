...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_otrade_b2b_order_target_supplier_di_sql_task(ds)
...
dim_otrade_b2b_supplier_info_hf_task >> app_otrade_b2b_order_target_supplier_di_task
dim_otrade_b2b_goods_info_hf_task >> app_otrade_b2b_order_target_supplier_di_task
dwm_otrade_b2b_shopping_cart_collect_di_task >> app_otrade_b2b_order_target_supplier_di_task
dwm_otrade_b2b_order_collect_di_task >> app_otrade_b2b_order_target_supplier_di_task
dwm_otrade_b2b_order_item_collect_di_task >> app_otrade_b2b_order_target_supplier_di_task
