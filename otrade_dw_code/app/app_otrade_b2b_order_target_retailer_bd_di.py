...
dag = airflow.DAG('app_otrade_b2b_order_target_retailer_bd_di',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "otrade_dw"
table_name = "app_otrade_b2b_order_target_retailer_bd_di"
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    # _sql = app_otrade_b2b_order_target_retailer_bd_di_sql_task(ds)
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_otrade_b2b_order_target_retailer_bd_di_sql_task(ds)
...
app_otrade_b2b_order_target_retailer_bd_di_task = PythonOperator(
    task_id='app_otrade_b2b_order_target_retailer_bd_di_task',
...
dwd_otrade_b2b_order_collect_di_task >> app_otrade_b2b_order_target_retailer_bd_di_task
