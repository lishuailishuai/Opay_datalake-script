...
dag = airflow.DAG('ods_sqoop_base_business_activity_record_di',
...
ods_binlog_base_business_activity_record_hi_task = OssSensor(
    task_id='ods_binlog_base_business_activity_record_hi_task',
    bucket_key='{hdfs_path_str}/dt={pt}/hour=22/_SUCCESS'.format(
        hdfs_path_str="opay_binlog/opay_transaction_db.opay_transaction.business_activity_record",
        pt='{{ds}}'
    ),
...
table_name = "ods_sqoop_base_business_activity_record_di"
hdfs_path = "oss://opay-datalake/opay_dw_sqoop_di/opay_transaction/business_activity_record"
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + ods_sqoop_base_business_activity_record_di_sql_task(ds)
