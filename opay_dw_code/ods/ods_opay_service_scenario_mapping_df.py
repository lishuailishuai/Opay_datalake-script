...
dag = airflow.DAG('ods_opay_service_scenario_mapping_df',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name="opay_dw_ods"
table_name="ods_opay_service_scenario_mapping_df"
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = ods_opay_service_scenario_mapping_df_sql_task(ds)
...
ods_opay_service_scenario_mapping_df_task