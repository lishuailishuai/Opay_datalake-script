...
dag = airflow.DAG('ods_sqoop_base_card_bin_df',
...
ods_binlog_base_card_bin_hi_task = OssSensor(
    task_id='ods_binlog_base_card_bin_hi_task',
    bucket_key='{hdfs_path_str}/dt={pt}/hour=22/_SUCCESS'.format(
        hdfs_path_str="opay_binlog/opay_channel_db.opay_channel.card_bin",
        pt='{{ds}}'
    ),
...
ods_sqoop_base_card_bin_df_pre_task = OssSensor(
    task_id='ods_sqoop_base_card_bin_df_pre_task',
...
table_name = "ods_sqoop_base_card_bin_df"
hdfs_path = "oss://opay-datalake/opay_dw_sqoop/opay_channel/card_bin"
config = eval(Variable.get("opay_time_zone_config"))


def ods_sqoop_base_card_bin_df_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = ods_sqoop_base_card_bin_df_sql_task(ds)
...
ods_sqoop_base_card_bin_df_task = PythonOperator(
    task_id='ods_sqoop_base_card_bin_df_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

ods_binlog_base_card_bin_hi_task >> ods_sqoop_base_card_bin_df_task
ods_sqoop_base_card_bin_df_pre_task >> ods_sqoop_base_card_bin_df_task
