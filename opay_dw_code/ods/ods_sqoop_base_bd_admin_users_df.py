...
dag = airflow.DAG('ods_sqoop_base_bd_admin_users_df',
...
ods_bd_admin_users_hi_check_task = OssSensor(
    task_id='ods_bd_admin_users_hi_check_task',
...
ods_sqoop_bd_admin_users_pre_check_task = OssSensor(
    task_id='ods_sqoop_bd_admin_users_pre_check_task',
...
table_name = "ods_sqoop_base_bd_admin_users_df"
hdfs_path = "oss://opay-datalake/opay_dw_sqoop/opay_agent_crm/bd_admin_users"
config = eval(Variable.get("opay_time_zone_config"))


def ods_sqoop_base_bd_admin_users_df_sql_task(ds):
    HQL = '''

    set hive.exec.dynamic.partition.mode=nonstrict;
    set hive.exec.parallel=true;
    with 
        bd_admin_users_di as (
            SELECT 
                id,
                username,
                mobile,
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = ods_sqoop_base_bd_admin_users_df_sql_task(ds)
...
ods_sqoop_base_bd_admin_users_df_task = PythonOperator(
...
ods_bd_admin_users_hi_check_task >> ods_sqoop_base_bd_admin_users_df_task
ods_sqoop_bd_admin_users_pre_check_task >> ods_sqoop_base_bd_admin_users_df_task
