...
dag = airflow.DAG('dwm_opay_user_scenario_last_tran_di',
...
table_name = "dwm_opay_user_scenario_last_tran_di"
...
set hive.exec.max.dynamic.partitions =10000;
    ...
    with tran as 
     ...
     INSERT overwrite TABLE opay_dw.dwm_opay_user_scenario_last_tran_di partition (country_code,dt)
     ...
     full join 
       (select * from opay_dw.dwm_opay_user_scenario_last_tran_di where dt<'{pt}') b 
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwm_opay_user_scenario_last_tran_di_sql_task(ds)
...
dwm_opay_user_scenario_last_tran_di_task = PythonOperator(
    task_id='dwm_opay_user_scenario_last_tran_di_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

dwd_opay_transaction_record_di_prev_day_task >> dwm_opay_user_scenario_last_tran_di_task
