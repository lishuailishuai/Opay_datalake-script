...
dag = airflow.DAG('dwm_opay_actransfer_user_di',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "opay_dw"
table_name = "dwm_opay_actransfer_user_di"
hdfs_path = "ufile://opay-datalake/opay/opay_dw/" + table_name

##----------------------------------------- 脚本 ---------------------------------------##

def dwm_opay_actransfer_user_di_sql_task(ds):
    ...
    SELECT sender_id,
           ...
           dt
    FROM
      (SELECT user_id as sender_id,
              'USER' as sender_type,
              'ACTransfer' as service_type,
               order_status,
               amount,
               country_code,
               dt
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwm_opay_actransfer_user_di_sql_task(ds)
...
dwm_opay_actransfer_user_di_task = PythonOperator(
    task_id='dwm_opay_actransfer_user_di_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

dependence_dwd_opay_merchant_transfer_card_record_di_prev_day_task>>dwm_opay_actransfer_user_di_task
dependence_dwd_opay_user_transfer_card_record_di_prev_day_task>>dwm_opay_actransfer_user_di_task