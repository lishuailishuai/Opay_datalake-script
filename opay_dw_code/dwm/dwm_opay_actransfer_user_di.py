...
dwm_opay_actransfer_user_di_task = HiveOperator(
...
dependence_dwd_opay_merchant_transfer_card_record_di_prev_day_task >> \
dependence_dwd_opay_user_transfer_card_record_di_prev_day_task >> \
sleep_time >> \
dwm_opay_actransfer_user_di_task >> \
touchz_data_success