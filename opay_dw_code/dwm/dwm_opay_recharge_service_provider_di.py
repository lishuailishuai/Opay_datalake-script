...
def dwm_opay_recharge_service_provider_di_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwm_opay_recharge_service_provider_di_sql_task(ds)
...
dwm_opay_recharge_service_provider_di_task = PythonOperator(
