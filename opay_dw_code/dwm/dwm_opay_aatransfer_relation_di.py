...
fill_dwm_opay_aatransfer_relation_di_task = HiveOperator(
    ...
    select
	t1.payment_relation_id, t2.name, t2.payment_relation_type, t2.role_relation_type, 'AATransfer' service_type, t1.order_amt, t1.order_cnt, t1.order_status,
...
dwm_opay_aatransfer_relation_di_task = HiveOperator(
    ...
    partition(country_code, dt)
    select
        t1.payment_relation_id, t2.name payment_relation_name, t2.payment_relation_type, t2.role_relation_type, 'AATransfer' service_type, t1.order_amt, t1.order_cnt, t1.order_status,
        t1.country_code, t1.dt
    from
    (
        select 
