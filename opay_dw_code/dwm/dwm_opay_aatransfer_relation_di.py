...
db_name="opay_dw"
table_name = "dwm_opay_aatransfer_relation_di"
hdfs_path="ufile://opay-datalake/opay/opay_dw/" + table_name



def dwm_opay_aatransfer_relation_di_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwm_opay_aatransfer_relation_di_sql_task(ds)
...
dwm_opay_aatransfer_relation_di_task = PythonOperator(
...
dim_opay_payment_relation_df_task >> dwm_opay_aatransfer_relation_di_task
dwd_opay_user_transfer_user_record_di_task >> dwm_opay_aatransfer_relation_di_task
dwd_opay_merchant_transfer_user_record_di_task >> dwm_opay_aatransfer_relation_di_task