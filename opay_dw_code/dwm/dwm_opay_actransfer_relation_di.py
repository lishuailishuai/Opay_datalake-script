...
dag = airflow.DAG('dwm_opay_actransfer_relation_di',
...
##----------------------------------------- 依赖 ---------------------------------------##
#依赖前一天分区
dwd_opay_user_transfer_card_record_di_task = UFileSensor(
...
#依赖前一天分区
dwd_opay_merchant_transfer_card_record_di_task = UFileSensor(
