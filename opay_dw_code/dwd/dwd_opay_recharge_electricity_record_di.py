...
dag = airflow.DAG('dwd_opay_recharge_electricity_record_di',
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_recharge_electricity_record_di_task >> touchz_data_success