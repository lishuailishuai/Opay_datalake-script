...
##---- hive operator ---##
# fill_dwd_opay_recharge_betting_record_di_task = HiveOperator(
#     task_id='fill_dwd_opay_recharge_betting_record_di_task',
#     hql='''
#     set hive.exec.dynamic.partition.mode=nonstrict;
#
#     insert overwrite table dwd_opay_recharge_betting_record_di
...
#         order_di.error_msg,
#         order_di.betting_provider service_provider,
#         case order_di.betting_provider
#             when 'BET9JA' then '201'
#             when 'SUPABET' then '202'
#             else '200'
#             end as service_provider_id,
#         order_di.recipient_betting_account recharge_account,
#         order_di.recipient_betting_name recharge_account_name,
#         order_di.outward_id,
...
#             end as country_code,
#         order_di.dt
#     from opay_dw_ods.ods_sqoop_base_betting_topup_record_di order_di
#     left join
#     (
#         select * from
#         (
...
##---- hive operator ---##
dwd_opay_recharge_betting_record_di_task = HiveOperator(
