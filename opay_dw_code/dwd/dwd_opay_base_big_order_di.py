...
ods_sqoop_base_big_order_di_prev_day_task = UFileSensor(
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_base_big_order_di_task
ods_sqoop_base_big_order_di_prev_day_task >> dwd_opay_base_big_order_di_task
dwd_opay_base_big_order_di_task >> touchz_data_success