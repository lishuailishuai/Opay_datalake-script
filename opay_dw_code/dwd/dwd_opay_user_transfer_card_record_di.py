...
dag = airflow.DAG('dwd_opay_user_transfer_card_record_di',
...
ods_sqoop_base_user_transfer_card_record_di_prev_day_task = UFileSensor(
...
def dwd_opay_user_transfer_card_record_di_sql_task(ds):
    ...
    (
        select 
            ...
            dt
        from
        opay_dw_ods.ods_sqoop_base_user_transfer_card_record_di 
        where dt='{pt}'
    ) order_di 
...
ods_sqoop_base_user_di_prev_day_task >> dwd_opay_user_transfer_card_record_di_task
