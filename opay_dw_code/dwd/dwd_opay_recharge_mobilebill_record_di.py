...
##---- hive operator ---##
# fill_dwd_opay_recharge_mobilebill_record_di_task = HiveOperator(
#     task_id='fill_dwd_opay_recharge_mobilebill_record_di_task',
#     hql='''
#     set hive.exec.dynamic.partition.mode=nonstrict;
#
#     insert overwrite table dwd_opay_recharge_mobilebill_record_di
...
#             end as country_code,
#         order_di.dt
#     from opay_dw_ods.ods_sqoop_base_airtime_topup_record_di order_di
#     left join
#     (
#         select * from
#         (
...
##---- hive operator ---##
dwd_opay_recharge_mobilebill_record_di_task = HiveOperator(
    ...
    alter table dwd_opay_recharge_mobilebill_record_di drop partition(country_code='NG',dt='{pt}');

    alter table dwd_opay_recharge_mobilebill_record_di add partition(country_code='NG',dt='{pt}');
     
    insert overwrite table dwd_opay_recharge_mobilebill_record_di partition(country_code, dt)
    select 
        order_di.id,
        order_di.order_no,
        order_di.user_id,
