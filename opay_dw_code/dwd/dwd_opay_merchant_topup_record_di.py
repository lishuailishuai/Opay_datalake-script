...
dag = airflow.DAG('dwd_opay_merchant_topup_record_di',
...
ods_sqoop_base_merchant_topup_record_di_prev_day_task = UFileSensor(
...
##----------------------------------------- 变量 ---------------------------------------##
db_name="opay_dw"
table_name = "dwd_opay_merchant_topup_record_di"
hdfs_path="ufile://opay-datalake/opay/opay_dw/" + table_name


##---- hive operator ---##
# fill_dwd_opay_merchant_topup_record_di_task = HiveOperator(
#     task_id='fill_dwd_opay_merchant_topup_record_di_task',
#     hql='''
#     set hive.exec.dynamic.partition.mode=nonstrict;
#
#     insert overwrite table dwd_opay_merchant_topup_record_di
...
#             end as country_code,
#         order_di.dt
#     from opay_dw_ods.ods_sqoop_base_merchant_topup_record_di order_di
#
#
#     '''.format(
#         pt='{{ds}}'
...
##---- hive operator ---##
def dwd_opay_merchant_topup_record_di_sql_task(ds):
    ...
    (
        select 
            ...
            dt
        from
        opay_dw_ods.ods_sqoop_base_merchant_topup_record_di 
        where dt='{pt}'
    ) order_di
...
def execution_data_task_id(ds, **kargs):
    ...
    _sql = dwd_opay_merchant_topup_record_di_sql_task(ds)
...
dwd_opay_merchant_topup_record_di_task = PythonOperator(
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_merchant_topup_record_di_task
ods_sqoop_base_merchant_topup_record_di_prev_day_task >> dwd_opay_merchant_topup_record_di_task