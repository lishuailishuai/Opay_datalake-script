...
##---- hive operator ---##
fill_dwd_opay_merchant_acquiring_record_di_task = HiveOperator(
    task_id='fill_dwd_opay_merchant_acquiring_record_di_task',
    hql='''
    ...
    select 
        ...
        order_di.dt
    from opay_dw_ods.ods_sqoop_base_merchant_acquiring_record_di order_di
    left join
    (
        select * from 
        (
...
##---- hive operator ---##
dwd_opay_merchant_acquiring_record_di_task = HiveOperator(
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_merchant_acquiring_record_di_task >> touchz_data_success