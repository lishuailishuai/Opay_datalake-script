...
##---- hive operator ---##
# fill_dwd_opay_merchant_transfer_card_record_di_task = HiveOperator(
#     task_id='fill_dwd_opay_merchant_transfer_card_record_di_task',
#     hql='''
...
#             end as country_code,
#         order_di.dt
#     from opay_dw_ods.ods_sqoop_base_merchant_transfer_card_record_di order_di
#
#
#     '''.format(
#         pt='{{ds}}'
...
##---- hive operator ---##
dwd_opay_merchant_transfer_card_record_di_task = HiveOperator(
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_merchant_transfer_card_record_di_task
ods_sqoop_base_merchant_transfer_card_record_di_prev_day_task >> dwd_opay_merchant_transfer_card_record_di_task
dwd_opay_merchant_transfer_card_record_di_task >> touchz_data_success