...
def dwd_opay_topup_with_card_record_di_sql_task(ds):
    ...
    select 
        ...
        t1.pay_way, t1.next_step, t1.out_channel_id, t1.business_type,
        case t1.country
            when 'NG' then 'NG'
            when 'NO' then 'NO'
            when 'GH' then 'GH'
    ...
    from (
        select 
            ...
            create_time, update_time, country, order_status, error_code, error_msg, client_source, pay_channel as pay_way, next_step, out_channel_id, business_type
        ...
        select 
            ...
            create_time, update_time, country, order_status, error_code, error_msg, '-' as client_source, pay_channel as pay_way, next_step, out_channel_id, '-' as business_type
...
ods_sqoop_base_merchant_di_prev_day_task >> dwd_opay_topup_with_card_record_di_task
