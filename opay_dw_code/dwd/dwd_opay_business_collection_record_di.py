...
##---- hive operator ---##
dwd_opay_business_collection_record_di_task = HiveOperator(
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_business_collection_record_di_task >> touchz_data_success