...
dag = airflow.DAG('dwd_opay_user_pos_transaction_record_di',
...
ods_sqoop_base_user_pos_transaction_record_di_prev_day_task = UFileSensor(
...
table_name = "dwd_opay_user_pos_transaction_record_di"
hdfs_path="ufile://opay-datalake/opay/opay_dw/" + table_name


##---- hive operator ---##
# fill_dwd_opay_user_pos_transaction_record_di_task = HiveOperator(
#     task_id='fill_dwd_opay_user_pos_transaction_record_di_task',
#     hql='''
...
#     )
#     insert overwrite table dwd_opay_user_pos_transaction_record_di
...
#             end as country_code,
#         order_di.dt
#     from opay_dw_ods.ods_sqoop_base_user_pos_transaction_record_di order_di
...
##---- hive operator ---##
dwd_opay_user_pos_transaction_record_di_task = HiveOperator(
    task_id='dwd_opay_user_pos_transaction_record_di_task',
    hql='''
    set hive.exec.dynamic.partition.mode=nonstrict;
    ...
    (
        select 
            ...
            dt
        from
        opay_dw_ods.ods_sqoop_base_user_pos_transaction_record_di 
        where dt='{pt}'
    ) order_di 
    left join user_data user_di on user_di.user_id = order_di.user_id
...
dim_opay_user_base_di_prev_day_task >> dwd_opay_user_pos_transaction_record_di_task
ods_sqoop_base_user_pos_transaction_record_di_prev_day_task >> dwd_opay_user_pos_transaction_record_di_task
dwd_opay_user_pos_transaction_record_di_task >> touchz_data_success