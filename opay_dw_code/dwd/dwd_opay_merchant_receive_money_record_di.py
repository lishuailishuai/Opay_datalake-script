...
ods_sqoop_base_merchant_receive_money_record_di_prev_day_task = UFileSensor(
...
##---- hive operator ---##
def dwd_opay_merchant_receive_money_record_di_sql_task(ds):
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwd_opay_merchant_receive_money_record_di_sql_task(ds)
...
dwd_opay_merchant_receive_money_record_di_task = PythonOperator(
...
ods_sqoop_base_user_di_prev_day_task >> dwd_opay_merchant_receive_money_record_di_task
ods_sqoop_base_merchant_receive_money_record_di_prev_day_task >> dwd_opay_merchant_receive_money_record_di_task