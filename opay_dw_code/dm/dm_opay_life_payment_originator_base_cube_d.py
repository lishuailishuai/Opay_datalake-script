...
dag = airflow.DAG('dm_opay_life_payment_originator_base_cube_d',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name="opay_dw"
table_name="dm_opay_life_payment_originator_base_cube_d"
hdfs_path="oss://opay-datalake/opay/opay_dw/"+table_name

##---- hive operator ---##
def dm_opay_life_payment_originator_base_cube_d_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dm_opay_life_payment_originator_base_cube_d_sql_task(ds)
...
dm_opay_life_payment_originator_base_cube_d_task = PythonOperator(
    task_id='dm_opay_life_payment_originator_base_cube_d_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

dwd_opay_life_payment_record_di_prev_day_task >> dm_opay_life_payment_originator_base_cube_d_task