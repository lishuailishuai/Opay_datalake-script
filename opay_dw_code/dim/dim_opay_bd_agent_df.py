...
dag = airflow.DAG('dim_opay_bd_agent_df',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name="opay_dw"
table_name="dim_opay_bd_agent_df"
hdfs_path="oss://opay-datalake/opay/opay_dw/"+table_name
config = eval(Variable.get("opay_time_zone_config"))

##---- hive operator ---##
def dim_opay_bd_agent_df_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dim_opay_bd_agent_df_sql_task(ds)
...
dim_opay_bd_agent_df_task = PythonOperator(
    task_id='dim_opay_bd_agent_df_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

ods_bd_agent_df_prev_day_task >> dim_opay_bd_agent_df_task