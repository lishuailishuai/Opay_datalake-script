...
dag = airflow.DAG('dim_opay_user_di',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name="opay_dw"
table_name="dim_opay_user_di"
hdfs_path="ufile://opay-datalake/opay/opay_dw/"+table_name

##---- hive operator ---##
def dim_opay_user_di_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dim_opay_user_di_sql_task(ds)
...
dim_opay_user_di_task = PythonOperator(
    task_id='dim_opay_user_di_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

ods_sqoop_base_user_di_task >> dim_opay_user_di_task