...
ods_sqoop_base_user_upgrade_df_prev_day_task >> ods_sqoop_base_user_email_di_prev_day_task \
>> ods_sqoop_base_user_di_prev_day_task >> dim_opay_user_base_di_task >> touchz_data_success