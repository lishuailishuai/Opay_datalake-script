...
dag = airflow.DAG('app_opay_transaction_consume_scenario_sum_ng_h',
                  schedule_interval="40 * * * *",
                  default_args=args,
                  )
##----------------------------------------- 变量 ---------------------------------------##
db_name = "opay_dw"
table_name = "app_opay_transaction_consume_scenario_sum_ng_h"
...
def app_opay_transaction_consume_scenario_sum_ng_h_sql_task(ds, v_date):
    HQL = '''
    ...
    from 
        ...
        from {db}.dwd_opay_transaction_record_hi 
        where 
            country_code='NG'
     ...
     where rn = 1
    group by country_code, top_consume_scenario, sub_consume_scenario, originator_type, originator_role,
             client_source, order_status,create_date_hour
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_opay_transaction_consume_scenario_sum_ng_h_sql_task(ds, v_date)
...
app_opay_transaction_consume_scenario_sum_ng_h_task = PythonOperator(
    task_id='app_opay_transaction_consume_scenario_sum_ng_h_task',
...
dwd_opay_transaction_record_hi_prev_day_task >> app_opay_transaction_consume_scenario_sum_ng_h_task
dwd_opay_transaction_record_hi_day_task >> app_opay_transaction_consume_scenario_sum_ng_h_task
