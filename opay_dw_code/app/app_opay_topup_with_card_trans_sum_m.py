...
dag = airflow.DAG('app_opay_topup_with_card_trans_sum_m',
...
table_name = "app_opay_topup_with_card_trans_sum_m"
hdfs_path = "oss://opay-datalake/opay/opay_dw/" + table_name


def app_opay_topup_with_card_trans_sum_m_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = app_opay_topup_with_card_trans_sum_m_sql_task(ds)
...
app_opay_topup_with_card_trans_sum_m_task = PythonOperator(
    task_id='app_opay_topup_with_card_trans_sum_m_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

dwd_opay_topup_with_card_record_di_task >> app_opay_topup_with_card_trans_sum_m_task
