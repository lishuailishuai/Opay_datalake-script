...
dag = airflow.DAG('app_opay_transaction_user_cnt_m',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name="opay_dw"
table_name="app_opay_transaction_user_cnt_m"
hdfs_path="oss://opay-datalake/opay/opay_dw/"+table_name

##---- hive operator ---##
def app_opay_transaction_user_cnt_m_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = app_opay_transaction_user_cnt_m_sql_task(ds)
...
app_opay_transaction_user_cnt_m_task = PythonOperator(
    task_id='app_opay_transaction_user_cnt_m_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

dwd_opay_transaction_record_di_prev_day_task >> app_opay_transaction_user_cnt_m_task