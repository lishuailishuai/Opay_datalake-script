...
def fun_task_timeout_monitor(ds,dag,**op_kwargs):
    ...
    msg = [
        {"dag":dag, "db": "opay_dw", "table":"{dag_name}".format(dag_name=dag_ids), "partition": "country_code=NG/dt={pt}".format(pt=airflow.macros.ds_add(ds, +6)), "timeout": "800"}
    ]
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = app_opay_pos_trans_sum_w_sql_task(ds)
