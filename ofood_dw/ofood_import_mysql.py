...
table_list = [
    ...
    # 订单相关数据
    ("food_operapay_co", "jh_order", "ofood_db", "order"),
    ("food_operapay_co", "jh_waimai_order", "ofood_db", "order"),
    ("food_operapay_co", "jh_waimai_comment", "ofood_db", "order"),
    ("food_operapay_co", "jh_order_time", "ofood_db", "order"),
    ("food_operapay_co", "jh_order_log", "ofood_db", "order"),

    # 商户信息
    ("food_operapay_co", "jh_shop", "ofood_db", "merchant"),
    ("food_operapay_co", "jh_waimai", "ofood_db", "merchant"),
    ...
    if len(cursor.fetchall()) == 0:
        ...
        for result in results:
            ...
            if result[1] == 'timestamp' or result[1] == 'varchar' or result[1] == 'char' or result[1] == 'text' or \
                    result[1] == 'datetime' or result[1] == 'mediumtext' or result[1] == 'enum':
                data_type = 'string'
