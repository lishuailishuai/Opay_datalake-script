...
UFILE_PATH = Variable.get("OBJECT_STORAGE_PROTOCOL") + 'opay-datalake/oride_dw_sqoop_di/%s/%s'
...
for db_name, table_name, conn_id, prefix_name,priority_weight_nm in table_list:
    ...
    add_partitions >> import_table >> volume_monitoring >> validate_all_data
