...
`
        ...
        select
            ...
            count(if(driver_id <> 0,id,null))/count(id),
            ...
            count(if(status = 6 and (cancel_role = 3 or cancel_role = 4),id,null))/count(id),
            count(if(status = 6 and driver_id = 0,id,null))/count(id),
            count(if(status = 6 and driver_id <> 0,id,null))/count(id)
