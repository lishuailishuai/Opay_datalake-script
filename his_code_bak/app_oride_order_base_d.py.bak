...
insert_result_to_hive_all = HiveOperator(
    ...
    hql='''
        ...
        SELECT 
            ...
            CASE WHEN a.orders IS NULL THEN 0 ELSE a.orders END,
            CASE WHEN a.orders_take IS NULL THEN 0 ELSE a.orders_take END,
            CASE WHEN a.take_range IS NULL THEN 0 ELSE a.take_range END,
            CASE WHEN a.orders_f IS NULL THEN 0 ELSE a.orders_f END,
            CASE WHEN a.avg_take_range IS NULL THEN 0 ELSE a.avg_take_range END, 
            CASE WHEN a.avg_take_range_tk IS NULL THEN 0 ELSE a.avg_take_range_tk END,
            CASE WHEN a.cancel_af_take_us IS NULL THEN 0 ELSE a.cancel_af_take_us END,
            CASE WHEN a.cancel_af_take_dr IS NULL THEN 0 ELSE a.cancel_af_take_dr END,
            CASE WHEN a.cancel_all IS NULL THEN 0 ELSE a.cancel_all END,
            CASE WHEN a.cancel_sys IS NULL THEN 0 ELSE a.cancel_sys END,
            CASE WHEN a.cancel_bf_take_us IS NULL THEN 0 ELSE a.cancel_bf_take_us END,
            CASE WHEN a.cancel_af_take_all IS NULL THEN 0 ELSE a.cancel_af_take_all END,
            CASE WHEN a.cancel_af_take_us_range IS NULL THEN 0 ELSE a.cancel_af_take_us_range END,
            CASE WHEN a.cancel_af_take_dr_range IS NULL THEN 0 ELSE a.cancel_af_take_dr_range END,
            CASE WHEN a.billing_range IS NULL THEN 0 ELSE a.billing_range END,
            CASE WHEN a.pick_range IS NULL THEN 0 ELSE a.pick_range END,
            CASE WHEN a.send_dis IS NULL THEN 0 ELSE a.send_dis END,
            CASE WHEN a.pay_range IS NULL THEN 0 ELSE a.pay_range END,
            CASE WHEN a.payed_orders IS NULL THEN 0 ELSE a.payed_orders END,
            CASE WHEN b.valid_order IS NULL THEN 0 ELSE b.valid_order END,
            'all' AS type,
...
insert_result_to_hive_city_type = HiveOperator(
    ...
    hql='''
        ...
        SELECT 
            ...
            CASE WHEN orders_take IS NULL THEN 0 ELSE orders_take END,
            CASE WHEN take_range IS NULL THEN 0 ELSE take_range END,
            CASE WHEN orders_f IS NULL THEN 0 ELSE orders_f END,
            CASE WHEN avg_take_range IS NULL THEN 0 ELSE avg_take_range END, 
            CASE WHEN avg_take_range_tk IS NULL THEN 0 ELSE avg_take_range_tk END, 
            CASE WHEN cancel_af_take_us IS NULL THEN 0 ELSE cancel_af_take_us END,
            CASE WHEN cancel_af_take_dr IS NULL THEN 0 ELSE cancel_af_take_dr END,
            CASE WHEN cancel_all IS NULL THEN 0 ELSE cancel_all END,
            CASE WHEN cancel_sys IS NULL THEN 0 ELSE cancel_sys END,
            CASE WHEN cancel_bf_take_us IS NULL THEN 0 ELSE cancel_bf_take_us END,
            CASE WHEN cancel_af_take_all IS NULL THEN 0 ELSE cancel_af_take_all END,
            CASE WHEN cancel_af_take_us_range IS NULL THEN 0 ELSE cancel_af_take_us_range END,
            CASE WHEN cancel_af_take_dr_range IS NULL THEN 0 ELSE cancel_af_take_dr_range END,
            CASE WHEN billing_range IS NULL THEN 0 ELSE billing_range END,
            CASE WHEN pick_range IS NULL THEN 0 ELSE pick_range END,
            CASE WHEN send_dis IS NULL THEN 0 ELSE send_dis END,
            CASE WHEN pay_range IS NULL THEN 0 ELSE pay_range END,
            CASE WHEN payed_orders IS NULL THEN 0 ELSE payed_orders END,
            0,
            'serv' AS type,
