...
dag_monitor = airflow.DAG(
    'oexpress_source_binlog_hi_monitor',
    schedule_interval=schedule_interval,
    default_args=args)
...
table_list = [
    ...
    ("oexpress_data", "data_user", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "data_order", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "data_transport_order", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "data_order_abnormal_record", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "data_order_payment", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ...
    ("oexpress_data", "data_hub", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "data_vehicle", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "finance_batch_records", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "finance_batchs", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "finance_pay_opay", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "finance_settlements", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "system_admin_users", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "conf_city", "oexpress_db", "base", 3, "oexpress_db", "false"),
    ("oexpress_data", "conf_country", "oexpress_db", "base", 3, "oexpress_db", "false"),
...
OSS_PATH = 'oss://opay-datalake/oexpress_binlog/%s'
