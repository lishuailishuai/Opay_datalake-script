...
# 依赖前一天分区
dependence_dwd_oride_order_dispatch_chose_detail_di_prev_day_tesk = HivePartitionSensor(
...
dependence_dwd_oride_order_dispatch_chose_detail_di_prev_day_tesk >> \
sleep_time >> \
