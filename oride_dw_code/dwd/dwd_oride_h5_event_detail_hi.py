...
dag = airflow.DAG('dwd_oride_h5_event_detail_hi',
...
def dwd_oride_h5_event_detail_hi_sql_task(ds, hour):
    HQL = '''
        ...
        FROM
         ...
         with opay_ep_logv1_data as (
            ...
            WHERE
                dt='{pt}'
                AND hour='{now_hour}'
                AND get_json_object(message, '$.typ') in ('h5')
        )
...
def execution_data_task_id(ds, **kwargs):
    ...
    # 读取sql
    _sql = dwd_oride_h5_event_detail_hi_sql_task(ds, v_hour)
...
dwd_oride_h5_event_detail_hi_task = PythonOperator(
    task_id='dwd_oride_h5_event_detail_hi_task',
...
opay_ep_logv0_prev_hour_task >> opay_ep_logv1_prev_hour_task >> dwd_oride_h5_event_detail_hi_task
