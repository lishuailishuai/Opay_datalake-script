...
dwd_oride_order_push_operation_info_di_task = HiveOperator(
...
ods_sqoop_algorithm_order_operation_info_di_task >> sleep_time >> dwd_oride_order_push_operation_info_di_task >> touchz_data_success
