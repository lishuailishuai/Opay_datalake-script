...
if code_map["id"].lower()=="ufile":
    ...
    hdfs_path = "oss://opay-datalake/oride/oride_dw/dwd_oride_promoter_users_device_df"
...
def dwd_oride_promoter_users_device_df_sql_task(ds):
    ...
    INSERT overwrite TABLE oride_dw.dwd_oride_promoter_users_device_df partition(country_code,dt)
...
'{pt}' as dt
    ...
    from oride_dw_ods.ods_sqoop_promoter_promoter_users_device_df
    where dt='{pt}'
...
def execution_data_task_id(ds,**kwargs):
    ...
    _sql="\n"+cf.alter_partition()+"\n"+dwd_oride_promoter_users_device_df_sql_task(ds)
...
dwd_oride_promoter_users_device_df_task= PythonOperator(
    task_id='dwd_oride_promoter_users_device_df_task',
...
ods_sqoop_promoter_promoter_users_device_df_tesk>>dwd_oride_promoter_users_device_df_task