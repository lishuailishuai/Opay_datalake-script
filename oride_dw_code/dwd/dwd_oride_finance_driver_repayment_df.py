...
if code_map["id"].lower()=="ufile":
    ...
    print("成功")
    ods_sqoop_base_data_driver_repayment_df_task = OssSensor(
        task_id='ods_sqoop_base_data_driver_repayment_df_task',
...
def dwd_oride_finance_driver_repayment_df_sql_task(ds):
    HQL='''
...
def execution_data_task_id(ds,**kargs):
    ...
    #读取sql
    _sql=dwd_oride_finance_driver_repayment_df_sql_task(ds)
...
dwd_oride_finance_driver_repayment_df_task= PythonOperator(
...
ods_sqoop_base_data_driver_repayment_df_task >> dwd_oride_finance_driver_repayment_df_task
