...
def dwd_oride_abnormal_order_df_sql_task(ds):
    ...
    INSERT overwrite TABLE oride_dw.dwd_oride_abnormal_order_df partition(country_code,dt)
...
def execution_data_task_id(ds,**kwargs):
    ...
    _sql="\n"+cf.alter_partition()+"\n"+dwd_oride_abnormal_order_df_sql_task(ds)
...
dwd_oride_abnormal_order_df_task= PythonOperator(
    task_id='dwd_oride_abnormal_order_df_task',
...
ods_sqoop_base_data_abnormal_order_df_tesk>>dwd_oride_abnormal_order_df_task