...
def dwd_oride_coupon_expired_df_sql_task(ds):
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwd_oride_coupon_expired_df_sql_task(ds)
...
dwd_oride_coupon_expired_df_task = PythonOperator(
...
ods_sqoop_base_data_coupon_expired_df_task >>  dwd_oride_coupon_expired_df_task
