...
def dwd_oride_driver_accept_order_click_detail_di_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwd_oride_driver_accept_order_click_detail_di_sql_task(ds)
...
dwd_oride_driver_accept_order_click_detail_di_task = PythonOperator(
