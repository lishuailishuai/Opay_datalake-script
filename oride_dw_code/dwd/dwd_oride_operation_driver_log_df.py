...
if code_map["id"].lower()=="ufile":
    ...
    print("成功")
    ods_sqoop_base_data_operation_driver_log_df_tesk = OssSensor(
        task_id='ods_sqoop_base_data_operation_driver_log_df_tesk',
    ...
    hdfs_path = "oss://opay-datalake/oride/oride_dw/dwd_oride_operation_driver_log_df"
...
operation_id,--操作人id
operation_name,--操作人
(operation_time + 1*60*60*1) as operation_time,--操作时间
