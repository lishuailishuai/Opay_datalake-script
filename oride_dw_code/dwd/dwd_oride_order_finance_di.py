...
dag = airflow.DAG('dwd_oride_order_finance_di',
...
db_name = "oride_dw"
table_name = "dwd_oride_order_finance_di"
hdfs_path = "ufile://opay-datalake/oride/oride_dw/" + table_name


##----------------------------------------- 脚本 ---------------------------------------##
def dwd_oride_order_finance_di_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwd_oride_order_finance_di_sql_task(ds)
...
dwd_oride_order_finance_di_task = PythonOperator(
...
dwd_oride_order_finance_di_task
