...
dwd_oride_driver_recharge_records_df_task = HiveOperator(
...
ods_sqoop_base_data_driver_recharge_records_df_task >> sleep_time >> dwd_oride_driver_recharge_records_df_task >> touchz_data_success
