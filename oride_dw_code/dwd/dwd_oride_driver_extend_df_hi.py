...
dag = airflow.DAG('dwd_oride_driver_extend_df_hi',
...
# 依赖前天分区
dwd_oride_driver_extend_df_hi_prev_day_tesk = OssSensor(
    task_id='dwd_oride_driver_extend_df_hi_prev_day_tesk',
...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "oride_dw"
table_name = "dwd_oride_driver_extend_df_hi"
...
def dwd_oride_driver_extend_df_hi_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dwd_oride_driver_extend_df_hi_sql_task(ds)
...
dwd_oride_driver_extend_df_hi_task = PythonOperator(
    task_id='dwd_oride_driver_extend_df_hi_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

ods_binlog_base_data_driver_extend_hi_prev_day_task >> dwd_oride_driver_extend_df_hi_task
dwd_oride_driver_extend_df_hi_prev_day_tesk >> dwd_oride_driver_extend_df_hi_task