...
##----------------------------------------- 变量 ---------------------------------------##
db_name = "oride_dw"
table_name = "dwm_oride_driver_act_m"
##----------------------------------------- 依赖 ---------------------------------------##
#获取变量
...
##----------------------------------------- 脚本 ---------------------------------------##
def dwm_oride_driver_act_m_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds,dag,**kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dwm_oride_driver_act_m_sql_task(ds)
...
dwm_oride_driver_act_m_task = PythonOperator(
...
dependence_dwd_oride_order_base_include_test_di_prev_day_task>>dwm_oride_driver_act_m_task