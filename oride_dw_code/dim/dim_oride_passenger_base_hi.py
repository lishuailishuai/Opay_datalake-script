...
dag = airflow.DAG('dim_oride_passenger_base_hi',
...
db_name = "oride_dw"
table_name = "dim_oride_passenger_base_hi"
...
def dim_oride_passenger_base_hi_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kargs):
    ...
    # 读取sql
    _sql = dim_oride_passenger_base_hi_sql_task(ds)
...
dim_oride_passenger_base_hi_task = PythonOperator(
    task_id='dim_oride_passenger_base_hi_task',
    python_callable=execution_data_task_id,
    provide_context=True,
    dag=dag
)

dwd_oride_passenger_df_prev_day_task >> dim_oride_passenger_base_hi_task
dwd_oride_passenger_extend_df_prev_day_task >> dim_oride_passenger_base_hi_task
