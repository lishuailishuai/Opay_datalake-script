...
FROM oride_dw.dwd_oride_order_push_driver_detail_di
   WHERE dt='{pt}'
     AND success=1
   GROUP BY driver_id) p1 ON ord.driver_id=p1.driver_id
...
dim_oride_driver_audit_base_prev_day_tesk>>dwd_oride_order_base_include_test_di_prev_day_tesk>>dwm_oride_driver_audit_third_extend_di_prev_day_tesk>>dwd_oride_order_push_driver_detail_di_prev_day_tesk>>oride_driver_timerange_prev_day_tesk>>sleep_time>>dm_oride_driver_base_cube_d_task>>touchz_data_success