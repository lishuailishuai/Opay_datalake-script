...
def dm_oride_passenger_base_multi_cube_sql_task(ds):
    HQL = '''
...
def execution_data_task_id(ds, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dm_oride_passenger_base_multi_cube_sql_task(ds)
...
dm_oride_passenger_base_multi_cube_task = PythonOperator(
    task_id='dm_oride_passenger_base_multi_cube_task',
...
dwm_oride_passenger_order_base_di_prev_day_task >> dm_oride_passenger_base_multi_cube_task
