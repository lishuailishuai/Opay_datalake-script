...
def execution_new_user_task(ds,dag,**kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_oride_new_user_cohort_m_sql_task(ds)
...
def execution_new_driver_task(ds,dag,**kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_oride_new_driver_cohort_m_sql_task(ds)
...
def execution_act_user_task(ds,dag,**kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_oride_act_user_cohort_m_sql_task(ds)
...
def execution_act_driver_task(ds,dag,**kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + app_oride_act_driver_cohort_m_sql_task(ds)
