...
insert_result_to_hive_all = HiveOperator(
    ...
    hql='''
        ...
        SELECT 
            ...
            NVL(a.orders_clicked_all, 0),
            NVL(b.driver_clicked_count, 0),
            NVL(b.drivers_clicked, 0),
            NVL(b.driver_avg_clicked, 0),
            NVL(c.order_showed_count, 0), 
            NVL(c.drivers_showed, 0),
            NVL(c.orders_showed, 0),
            NVL(d.payed_online, 0),
            NVL(d.payed_offline, 0),
            NVL(e.driver_reward, 0),
            NVL(f.driver_do_range, 0),
            NVL(f.drivers_order_finished, 0),
            NVL(g.driver_free_range, 0),
            NVL(g.drvers_online, 0),
            'all' AS type,
