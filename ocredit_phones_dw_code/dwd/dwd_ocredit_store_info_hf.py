...
dag = airflow.DAG('dwd_ocredit_store_info_hf',
...
table_name = "dwd_ocredit_store_info_hf"
...
### 检查当前小时的分区依赖
ods_binlog_base_t_store_info_h_his_check_task = OssSensor(
    task_id='ods_binlog_base_t_store_info_h_his_check_task',
    bucket_key='{hdfs_path_str}/dt={pt}/hour={hour}/_SUCCESS'.format(
        hdfs_path_str="ocredit_phones_h_his/ods_binlog_base_t_store_info_h_his",
        pt='{{ds}}',
...
def dwd_ocredit_store_info_hf_sql_task(ds, v_date):
    HQL = '''
    ...
    select id,                            --                                                   
            ...
            contacter_name,                -- 门店主要联系人姓名                                         
            contacter_position,            -- 门店主要联系人职位                                         
            contacter_phone,               -- 门店主要联系人电话                                         
            store_tele,                    -- 门店座机号码                                            
            ...
            bank_name,                     -- 收款方银行                                             
            bank_number,                   -- 收款方银行卡号                                           
            store_status,                  -- 0:待审核    1:审核通过   2:审核拒绝    3暂停                   
            audit_desc,                    -- 审核描述                                              
    ...
    from (select *,
             ...
             from ocredit_phones_dw_ods.ods_binlog_base_t_store_info_h_his
            where 
...
def execution_data_task_id(ds, dag, **kwargs):
    ...
    # 读取sql
    _sql = "\n" + cf.alter_partition() + "\n" + dwd_ocredit_store_info_hf_sql_task(ds, v_date)
...
dwd_ocredit_store_info_hf_task = PythonOperator(
    task_id='dwd_ocredit_store_info_hf_task',
...
ods_binlog_base_t_store_info_h_his_check_task >> dwd_ocredit_store_info_hf_task
